...
import { PreguntasPerifericasOrden } from "../../data/PreguntasPerifericas/PreguntasPerifericasOrden";
import AuditoriaContext, { AUDIT_TYPES } from "../../context/AuditoriaContext";
import BackButton from "../../components/Buttons/BackButton/BackButton";
import SaveButton from "../../components/Buttons/SaveButton/SaveButton";
import QuestionItem from "../../components/QuestionItem/QuestionItem";

const PerifericasOrdenFormPage = () => {
    const {
        respuestasSecciones,
    ...
    const handleSave = () => {
        ...
        navigate("/categorias-auditoria-perifericas-limpieza");
    };
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-r from-primary to-secondary rounded-xl px-6 py-4 shadow-md">
                        <h1 className="text-2xl font-bold text-white text-center">
                            Auditoría de perífericas - Categoría Orden
                        </h1>
                    ...
                    <form className="bg-white shadow-xl rounded-b-xl overflow-hidden">
                        <div className="p-6 sm:p-8 space-y-8">
                            {
                                PreguntasPerifericasOrden.map((pregunta, index) =>(
                                    <QuestionItem
                                        key={ pregunta.id }
                                        index={ index }
                                        pregunta={ pregunta }
...
export default PerifericasOrdenFormPage