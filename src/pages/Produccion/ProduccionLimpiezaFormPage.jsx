...
import { PreguntasProduccionLimpiezaData } from "../../data/PreguntasProduccion/PreguntasProduccionLimpieza";
import AuditoriaContext from "../../context/AuditoriaContext";

const ProduccionLimpiezaFormPage = () => {
    const { respuestasSecciones, setRespuestasSecciones } = useContext(AuditoriaContext);

    const [respuestas, setRespuestas] = useState(respuestasSecciones.limpieza || {});
    ...
    const handleSave = () =>{
        ...
        handleNavigate("/categorias-auditoria-produccion-estandar");
    };
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-r from-primary to-secondary rounded-xl px-6 py-4 shadow-md">
                        <h1 className="text-2xl font-bold text-white text-center">
                            Auditoría de producción - Categoría Limpieza
                        </h1>
                    ...
                    <form className="bg-white shadow-xl rounded-b-xl overflow-hidden">
                        <div className="p-6 sm:p-8 space-y-8">
                            {
                                PreguntasProduccionLimpiezaData.map((pregunta, index) =>(
                        ...
                        <div className="bg-gray-50 px-6 py-4 flex justify-between items-center border-t border-gray-200">
                            <button
                                type="button"
                                onClick={ () => handleNavigate("/categorias-auditoria-produccion-orden") }
...
export default ProduccionLimpiezaFormPage