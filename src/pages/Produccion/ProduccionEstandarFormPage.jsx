...
const ProduccionEstandarFormPage = () => {
    ...
    const [respuestas, setRespuestas] = useState(respuestasSecciones.estandar || {});
    ...
    const handleSave = () => {
        ...
        handleNavigate("/categorias-auditoria-produccion-sostener");
    };
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <form className="bg-white shadow-xl rounded-b-xl overflow-hidden">
                        ...
                        <div className="bg-gray-50 px-6 py-4 flex justify-between items-center border-t border-gray-200">
                            <button
                                type="button"
                                onClick={ () => handleNavigate("/categorias-auditoria-produccion-limpieza") }
