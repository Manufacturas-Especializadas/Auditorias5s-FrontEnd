...
import { PreguntasProduccionData } from "../../data/PreguntasProduccionData";
import AuditoriaContext from "../../context/AuditoriaContext";

const ProduccionSeleccionFormPage = () => {
    const { respuestasSecciones, setRespuestasSecciones } = useContext(AuditoriaContext);

    const [respuestas, setRespuestas] = useState(respuestasSecciones.seleccion || {});
    ...
    const handleSave = () => {
        ...
        handleNavigate("/categorias-auditoria-produccion-orden");
    };
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-r from-primary to-secondary rounded-xl px-6 py-4 shadow-md">
                        <h1 className="text-2xl font-bold text-white text-center">
                            Auditoría de producción - Categoría Selección
                        </h1>
                    ...
                    <form className="bg-white shadow-xl rounded-b-xl overflow-hidden">
                        <div className="p-6 sm:p-8 space-y-8">
                            {
                                PreguntasProduccionData.map((pregunta, index) =>(
...
export default ProduccionSeleccionFormPage