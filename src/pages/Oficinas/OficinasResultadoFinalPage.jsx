...
const OficinasResultadoFinalPage = () => {
    const {
        auditState,
        setAuditType,
        clearAllData
    ...
    const { auditorData, respuestasSecciones } = auditState[AUDIT_TYPES.OFICINAS] || {
        auditorData: {},
        respuestasSecciones: {
            seleccion: {},
            orden: {},
    ...
    useEffect(() => {
        ...
        console.log("Datos de oficinas:", auditState[AUDIT_TYPES.OFICINAS]);
    }, [setAuditType]);
...
export default OficinasResultadoFinalPage