...
import { PreguntasOficinasSeleccion } from "../../data/PreguntasOficinas/PreguntasOficinasSeleccion";
...
const OficinasSeleccionFormPage = () => {
    const {
        respuestasSecciones,
    ...
    const handleBack = () => {
        navigate("/ingresar-nombre-oficinas");
    };
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-r from-primary to-secondary rounded-xl px-6 py-4 shadow-md">
                        <h1 className="text-2xl font-bold text-white text-center">
                            Auditoría de oficinas - Categoría Selección
                        </h1>
                    ...
                    <form className="bg-white shadow-xl rounded-b-xl overflow-hidden">
                        <div className="p-6 sm:p-8 space-y-8">
                            {
                                PreguntasOficinasSeleccion.map((pregunta, index) =>(
                                    <QuestionItem
                                        key={ pregunta.id }
                                        index={ index }
                                        pregunta={ pregunta }
...
export default OficinasSeleccionFormPage